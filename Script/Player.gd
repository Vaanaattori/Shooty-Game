...
@onready var Weapon = $Neck/Camera3D/Weapons

#var wepName = Weapon.wepName
@onready var ammoCount = Weapon.ammoCount
@onready var magSize = Weapon.magSize
@onready var FireRate = Weapon.FireRate

var weaponout = "primary"
...
var isMovingcheck
@onready var ammoInMag = Weapon.magSize
...
func _ready():
	...
	if Weapon.weaponCount > 0:
		FireRateTimer.wait_time = Weapon.FireRate
